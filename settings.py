...
LOGIN_BOT = '@' # логин бота
CHANNEL_ID = 29383882 # id канала куда будет отсылаться информация, ид без -100 в начале (например: 124873248)

admin_id = 99999 # id админа

LOGIN_ADMIN = '@' # тг логин спамера, нужен для информации

QIWI_NUMBER = '+777777'    # номер киви
